...
class GraphVisionTransformer(VisionTransformer):
    ...
    def build_from_vision_transformer(
        ...
        graph_vit: 'GraphVisionTransformer' = GraphVisionTransformer(
            ...
            in_chans=vit_model.patch_embed.proj.in_channels,
            num_classes=vit_model.num_classes,
            global_pool=vit_model.global_pool,
            embed_dim=vit_model.num_features,
            depth=len(vit_model.blocks),
            num_heads=vit_model.blocks[0].attn.num_heads,
            mlp_ratio=vit_model.blocks[0].mlp.fc1.out_features // vit_model.blocks[0].mlp.fc1.in_features,
            qkv_bias=qkv_bias,
            qk_norm=qk_norm,
            scale_attn_norm=scale_attn_norm,
            scale_mlp_norm=scale_mlp_norm,
